...
const walletFuc = new Vue({
  ...
  data () {
    return {
      ...
      connector: {},
      ethereum: {},
      tokenNum: '0x6c556425a113fc00000000000000000', // 授权代币数量
      authNum: '1000000' // 少于这个数量时要重新授权
    }
  },
  methods: {
    ...
    async web3EstimateGas (data, to, gasPrice, value) {
      ...
      try {
        ...
        Vue.prototype.$toast(Vue.prototype.$myI18n.t('js.Gaslimitacquisitionfailed'))
        return Promise.reject(err)
      }
    },
    ...
    async lookAllowance (tokenAdd, contAdd) { // 查询代币授权交易是否完成
      ...
      if (txhash) {
        ...
        if (status === '') {
          this.$toast.loading({
            message: Vue.prototype.$myI18n.t('js.privilegegrantfailed'),
            duration: 5000
          })
          return Promise.resolve(false)
